...
## Update v35 – Tema & Template Baru

Perubahan:
- Menambahkan menu **Tema** sebelum memilih template.
- Menambahkan 122 template baru dari `New.zip`.
- Template baru dikelompokkan ke tema: Anime Pirate / Wanted Poster, Selamat Lulus Pendadaran, Seminar Kerja Praktek, dan TI UMY / Campus & Newspaper.
- Area foto yang masih hitam/checker/blank diproses menjadi transparan otomatis sejauh dapat dideteksi.
- File template baru diperkecil menjadi `.png` 720×1280 agar ukuran ZIP lebih ringan; saat digunakan di canvas LabShot tetap diskalakan ke Story IG 1080×1920.
- Lihat `assets/frames/new/manifest.json` untuk daftar template dan koordinat slot foto.
